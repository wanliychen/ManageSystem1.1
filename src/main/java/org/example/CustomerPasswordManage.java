...
//     //             if (parts.length >= 6 && parts[0].equals(username) && parts[1].equals(oldPassword)) {
//     //                 writer.write(username + ";" + newPassword + ";" + parts[2] + ";" + parts[3] + ";" + parts[4] + ";" + parts[5]);
//     //                 writer.newLine();
...
//             while ((line = reader.readLine()) != null) {
//                 String[] parts = line.split(";");
//                 if (parts.length >= 6 && parts[0].equals(username) && parts[2].equals(email)) {
//                     return true;
//                 }
//             }
//         } catch (IOException e) {
